...
## Шрифты
Все используемые шрифты хранятся в корне репозитория:
...
## Настройки
- выбор цветовой темы и толщины неонового свечения активных полей;
- управление семейством и размером шрифта;
- поля для прокси‑сервера и API‑ключей;
- конфигурация хранится в [`app/settings.py`](app/settings.py).
